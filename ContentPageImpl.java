package /** SPECIFY_YOUR_PROPER_PATH e.g., com.yext.aem.common.components; */
...
import com.yext.aem.common.components.beans.Eyebrow;
import com.yext.aem.common.models.ContentPage;
import com.yext.aem.common.utils.AssetUtil;
...
public class ContentPageImpl implements ContentPage {
	...
	protected static final String RESOURCE_TYPE_V1 = "yext/common/components/page/contentpage";
	...
	private static final String TEXT_RESOURCE_TYPE = "yext/yextSite/components/content/text";  /** THIS FILTERS TO THE TEXT COMPONENTS ON A PAGE. THIS IS REQUIRED */
